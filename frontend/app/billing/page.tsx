...
import type { CreditPack, SubscriptionPlan } from "@/lib/credit-packs";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          <div>
            <Link
              href="/dashboard"
              className="text-sm text-zinc-400 hover:text-white transition mb-2 block"
            >
              ← Back to dashboard
            </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="text-sm text-zinc-400 mb-1">/month</div>
...
/**
 * /billing — credit pack + subscription storefront.
 *
 * Shows available credit packs, subscription plans, current balance,
 * and initiates Stripe Checkout when a user clicks "Buy" or "Subscribe".
 */
